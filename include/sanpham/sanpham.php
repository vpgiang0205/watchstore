<?php
	...
	$ma=$_POST['MaLH'];
		...
		$strSQLH="SELECT * FROM loai_sanpham WHERE ma_loai={$ma}";
		$hienthiloai= mysqli_query($ung,$strSQLH);
		$rowH=@mysqli_fetch_array($hienthiloai);
		$inloaisanpham=$rowH['ten_loai'];
	}
...
<script>
	...
	{
		giang.masanpham.value=masp
		giang.view.value="chitiet"
		giang.submit()
	}
</script>
<div style="width:587px; margin-left:3px; margin-right:3px;">
  ...
  <table width="587" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			&nbsp;&nbsp;Danh Sách Sản Phẩm <?php if($inloaisanpham!="") echo $inloaisanpham; ?>
							...
							<table width="437" cellpadding="0" cellspacing="0" border="0">
								<tr> 
									<td height="20" align="center">
										...
										Tên Sản Phẩm:</span> 								
										<span class="ten">
										<a href="#" onclick="chitiet('<?php echo $row['ma_sp']; ?>')"><b><?php echo $row									                                         ['ten_sp']; ?></b></a>
										</span>
											
												<?php
												// hien trang thai cua sp
													if($row['trang_thai']==1)
