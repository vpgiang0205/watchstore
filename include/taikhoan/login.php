...
<table width="220">
		<tr>
			...
			&nbsp;&nbsp;Đăng Nhập			
	<button type="button" style ="height:20px; width:90px; margin-left: 20px "name="gotoadmin"><a href= "http://localhost/dongho/adm/index.php">Admin Page</a></button>
		 </td>
		</tr>
		<tr>
			<td>
			<form action="" method="post" name="formdangnhap">
			    ...
			    <table width="227" height="105" cellpadding="0" cellspacing="0" border="0" style="border:#CCCCCC 1px solid; margin-top:3px;">
				  ...
				  <td>
                    ...
                    <td colspan="2" align="center"  height="30" style="text-align:center;"><a href="#" onclick="dangky_onsubmit('dangky')">Đăng ký</a>
                  </tr>
                  <?php } else { ?>
                  <tr>
