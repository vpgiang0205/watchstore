...
// Images Directory
imagesDir = "../js/openwysiwyg/icons/";

// CSS Directory
cssDir = "../js/openwysiwyg/styles/";

// Popups Directory
popupsDir = "../js/openwysiwyg/popups/";
...
function formatText(id, n, selected) {
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	if (viewTextMode == 1 && disabled_id == 1) {
      ...
      var popW = 214, popH = 165;
      var leftPos = (w-popW)/2, topPos = (h-popH)/2;
      var currentColor = _dec_to_rgb(document.getElementById("wysiwyg" + n).contentWindow.document.queryCommandValue(id));
   
	    window.open(popupsDir + 'select_color.html?color=' + currentColor + '&command=' + id + '&wysiwyg=' + n,'popup','location=0,resizable=1,status=0,scrollbars=0,width=' + popW + ',height=' + popH + ',top=' + topPos + ',left=' + leftPos);
    }
